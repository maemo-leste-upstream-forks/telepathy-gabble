...
/* BOOLEAN:POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.P3YRFT:1) */
...
/* BOOLEAN:STRING,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.P3YRFT:2) */
...
/* BOOLEAN:STRING,BOXED,POINTER,POINTER,POINTER (/tmp/dbus-binding-tool-c-marshallers.P3YRFT:3) */
