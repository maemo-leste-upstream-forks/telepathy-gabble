...
/* VOID:STRING,STRING (gabble-media-channel-signals-marshal.list:1) */
void
...
/* VOID:UINT,UINT (gabble-media-channel-signals-marshal.list:2) */
void
...
/* VOID:UINT,UINT,UINT (gabble-media-channel-signals-marshal.list:3) */
void
